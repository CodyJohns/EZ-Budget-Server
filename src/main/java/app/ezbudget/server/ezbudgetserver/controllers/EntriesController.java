...
public class EntriesController {
    ...
    public ResponseEntity<String> allEntriesPaged(@RequestHeader("Authorization") String authtoken,
    ...
    @GetMapping("/full/{id}")
    public ResponseEntity<String> fullEntry(@RequestHeader("Authorization") String authtoken,
    ...
    @PostMapping("/add")
    public ResponseEntity<String> addEntry(@RequestHeader("Authorization") String authtoken,
    ...
    @PostMapping("/update")
    public ResponseEntity<String> updateEntry(@RequestHeader("Authorization") String authtoken,
            @RequestParam("json") String json) {
    ...
    public ResponseEntity<String> deleteEntry(@RequestHeader("Authorization") String authtoken,
            @PathVariable("id") String id) {
    ...
    public ResponseEntity<String> isEntryMarked(@RequestHeader("Authorization") String authtoken,
            @PathVariable("id") String id) {
    ...
    @PostMapping("/mark")
    public ResponseEntity<String> markEntry(@RequestHeader("Authorization") String authtoken,
            @RequestParam("id") String id, @RequestParam("marked") boolean marked) {
    ...
    public ResponseEntity<String> itemHistory(@RequestHeader("Authorization") String authtoken,
